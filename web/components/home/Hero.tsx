...
const SLIDES = [
  { src: '/images/hero/hero-1.jpg', alt: 'Children learning together' },
  { src: '/images/hero/hero-2.jpg', alt: 'Parent and child studying at home' },
  { src: '/images/hero/hero-3.jpg', alt: 'Family homework session' },
  { src: '/images/hero/hero-4.jpg', alt: 'Child doing homework at a desk' },
  { src: '/images/hero/hero-5.jpg', alt: 'Happy student in classroom' },
  { src: '/images/hero/hero-6.jpg', alt: 'Teacher helping student with math' },
]
      ...
      <div className="relative z-10">
        <div className="content-container py-24 lg:py-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              {/* Eyebrow */}
              <div className="inline-flex items-center gap-2 bg-white/15 text-teal-200 text-xs font-semibold
                              tracking-widest uppercase px-3 py-1.5 rounded-full mb-6 backdrop-blur-sm">
                <Sparkles size={12} />
                AI-Assisted · Real-Person Guided
              </div>

              {/* H1 */}
              <h1 className="font-serif font-extrabold text-white leading-tight mb-6
                             text-4xl sm:text-5xl lg:text-[3.5rem]">
                We Believe in Every Child&apos;s{' '}
                <span className="text-teal-300">Unlimited Potential</span>
              </h1>

              {/* Subheadline */}
              <p className="text-teal-300 font-semibold text-lg mb-5 leading-snug">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link
                  href="/how-it-works"
                  className="inline-flex items-center justify-center gap-2
                             bg-white/15 hover:bg-white/25 text-white font-bold text-base
                             px-7 py-4 rounded-full border-2 border-white/30
              ...
              {/* Trust micro-copy */}
              <p className="mt-5 text-sm text-gray-300 font-medium">
        ...
        {/* ── Tagline strip ── */}
        <div className="bg-blue-900/90 backdrop-blur-sm py-4">
